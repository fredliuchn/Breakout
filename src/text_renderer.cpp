...
{
	std::string strspritevs = m_workspace + "\\..\\resources\\shader\\text_2d.vs";
	std::string strspritefs = m_workspace + "\\..\\resources\\shader\\text_2d.fs";
    TextShader = ResourceManager::LoadShader(strspritevs.c_str(), strspritefs.c_str(), nullptr, "text");
